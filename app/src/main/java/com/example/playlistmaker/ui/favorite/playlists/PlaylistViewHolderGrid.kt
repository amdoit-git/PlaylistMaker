...
class PlaylistViewHolderGrid(private val binding: PlaylistInGridBinding) : PlaylistViewHolder(binding.root) {
    ...
    companion object {
        fun create(parent: ViewGroup): PlaylistViewHolderGrid {
            return PlaylistViewHolderGrid(
